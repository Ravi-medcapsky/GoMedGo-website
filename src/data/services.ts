...
export const services: Service[] = [
  {
    ...
    LastLine: "💙 Because care begins at home.",
    image: "/expert.png",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    features: [
      "Personalized Daily Assistance – Support with mobility, meals, hygiene, and everyday routines",
      "Medical Monitoring – Regular check of vitals, medication reminders, and health updates",
      "Post-Surgery Recovery Support – Professional guidance for faster, safer recovery",
      "Elderly Care – Gentle and patient-centered assistance for seniors",
      "Companionship & Emotional Care – Because healing is not only physical but also emotional",
    ],
  ...
  },
  {
    ...
    paragraph:
      "With our Injections & Infusions, timely treatments are no longer stressful—healing becomes easier, safer, and more comfortable at home.",
    LastLine: "",
    image: "/injection.png",
  },
  {
    id: 5,
    title: "Elderly Bath & Hygiene Care 🛁",
  ...
  },
  {
    ...
    paragraph:
      "With skilled nurses and compassionate care, our dressing and wound care service ensures faster healing, better comfort, and complete safety—right at home.",
    LastLine: "",
    image: "/dressing.png",
  },
  {
    id: 7,
    title: "Physiotherapy Caretaker 🏃‍♂️",
    description:
    ...
    paragraph:
      "With skilled and compassionate physiotherapy caretakers, patients regain mobility, confidence, and a better quality of life — right at home.",
    LastLine: "",
    image: "/physio.png",
  },
  {
